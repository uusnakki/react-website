      ...
      <Router class="navbar navbar-expand-lg bg-dark py-md-3" style={styles.navigation}>
        <div>
          <Link style={padding} to="/">
            <img
              src={
                "https://static.thenounproject.com/png/423483-200.png"
              }
              alt="home"
